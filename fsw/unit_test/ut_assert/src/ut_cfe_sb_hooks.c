...
**
** $Id: ut_cfe_sb_hooks.c 1.2 2016/06/23 14:39:05EDT czogby Exp  $
**
...
** Revision 1.6 2015/06/16 16:14:02EDT sstrege 
** Added copyright information
** Revision 1.5 2015/05/01 13:33:01EDT czogby 
** Add UtAssert fail where error message generated, delete TimeStampMsgHook, add CCSDS header macros
** Revision 1.4 2015/03/10 15:21:47EDT czogby 
** Add Missing Functionality to UT Assert Library
** --- Added comments ---  czogby [2015/03/31 18:27:51Z]
...
void Ut_CFE_SB_AddMsgToPipe(void *MsgPtr, CFE_SB_PipeId_t PipeId)
{
    ...
    {
        UtAssert_True(FALSE, "Error - Invalid PipeId");
    }
}

int32 Ut_CFE_SB_CreatePipeHook(CFE_SB_PipeId_t *PipeIdPtr, uint16  Depth, const char *PipeName)
{
